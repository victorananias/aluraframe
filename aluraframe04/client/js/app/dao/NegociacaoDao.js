class NegociacaoDao {
    ...
    adicionar(negociacao) {
        return new Promise((resolve, reject) => {
            let request = this._conexao.transaction([this._banco], "readwrite").objectStore(this._banco).add(negociacao);
    ...
    listarTodos() {
        return new Promise((resolve, reject) => {
            let cursor = this._conexao.transaction([this._banco], "readwrite").objectStore(this._banco).openCursor();
            let negociacoes = [];
    ...
    apagarTodos() {
        return new Promise((resolve, reject) => {
            let request = this._conexao.transaction([this._banco], "readwrite").objectStore(this._banco).clear();
